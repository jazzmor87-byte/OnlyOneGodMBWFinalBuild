...
import {
  ...
  TravelBookingScreen,
  TravelLocalScreen,
  TravelOverseasScreen,
} from './MBWGoldenMasterScreens';
...
const ROUTES = [
  ['CinematicIntro', CinematicIntroScreen],
  ['GateLocked', GateLockedScreen],
  ['GateOpen', GateOpenScreen],
  ['PathSelection', PathSelectionScreen],
  ['SubscriptionSignup', SubscriptionSignupScreen],
  ['MainHub', MainHubScreen],
  ['MasterOfLife', MasterOfLifeScreen],
  ['Matchmaking', MatchmakingScreen],
  ['Games', GamesScreen],
  ['MasterOfGames', MasterOfGamesScreen],
  ['MasterOfCoins', MasterOfCoinsScreen],
  ['TravelLocal', TravelLocalScreen],
  ['TravelOverseas', TravelOverseasScreen],
  ['Merchandise', MerchandiseScreen],
  ['Kamashastra', KamashastraScreen],
  ...
  ['TravelBooking', TravelBookingScreen],
  ['CommerceReceipt', CommerceReceiptScreen],
  ['Privacy', PrivacyScreen],
  ['Terms', TermsScreen],
  ['Safety', SafetyScreen],
  ['AccountControl', AccountControlScreen],
  ['SeedProfile', SeedProfileScreen],
...
export default function MBWGoldenMasterNavigator() {
  return (
    <Stack.Navigator initialRouteName="CinematicIntro" screenOptions={{ headerShown: false, animation: 'fade', gestureEnabled: true }}>
