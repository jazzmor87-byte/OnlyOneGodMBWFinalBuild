import { mbwProductionConfigStatus } from '../production/MBWProductionConfig';
...
export const MBW_PRIVACY_SECTIONS = Object.freeze([
  ...
  ['LOCAL STORAGE', 'Production data is encrypted before persistence. The encryption key is stored through the device keystore. Android backup is disabled for MBW application data.'],
  ...
  ['PERMISSIONS', 'MBW does not require camera, microphone, contacts, SMS, call-log, or broad external-storage permissions for the APK certification workflow.'],
...
export const MBW_TERMS_SECTIONS = Object.freeze([
  ...
  ['GAMES AND COINS', 'MBW coins have no cash value. Production games, rewards, and purchases require published rules, fairness controls, and territory eligibility.'],
  ['TRAVEL', 'Travel bookings follow the published host, cancellation, safety and dispute terms. Production hosting requires identity checks, cancellation rules, safety escalation, and local-law compliance.'],
  ['MERCHANDISE', 'Orders require confirmed payment, inventory allocation, fulfilment and refund handling. Production checkout requires final pricing, taxes, delivery, refund, and seller information.'],
  ...
  ['AVAILABILITY', 'Service availability is monitored through the production support channel. Public release requires a service-status process and support channel.'],
...
export const MBW_CONSENT_SECTIONS = Object.freeze([
  ...
  ['SOCIAL', 'Process posts, stories, reports, blocks and chats through authenticated production services.'],
  ['ANALYTICS', 'No production analytics consent is enabled in the APK certification build.'],
