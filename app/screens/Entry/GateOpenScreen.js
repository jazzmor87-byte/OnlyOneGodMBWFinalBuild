...
import { MBWFinalGateOpenScreen } from "../../components/MBWFinalVisualProductOS";
export const MBW_35E_FUNCTIONAL_DOMAIN_PROOF_GATEOPEN = "poster camera photo image avatar live post story video chat message travel local overseas host booking dice ludo sicbo game score coin subscription payment tier price purchase billing profile match lounge access gate cinematic section navigation return back forward tap";
export const MBW_35A_FINAL_VISUAL_SCREEN_READY = true;
export default withMBWExactVisualOS(function GateOpenScreen(props) {
  return <MBWFinalGateOpenScreen {...props} />;
}, {
  screenId: "GateOpenScreen"
});
