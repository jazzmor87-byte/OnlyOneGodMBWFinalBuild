      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.overlay}>
          ...
          <View style={styles.actions}>
            <TouchableOpacity style={styles.primaryBtn} onPress={() => go(['signup_main', 'subscription_main', 'GamesScreen', 'KamashastraScreen', 'HomeHub'])}>
              <Text style={styles.primaryText}>Continue</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.secondaryBtn} onPress={() => go(['login_main', 'border_crossing', 'HomeHub', 'MBWHome', 'RealmHome'])}>
