...
export default function subscription_main() {
  const navigation = useNavigation();
  const __mbwPosterPool = getPosterPoolForScreen("app/screens/finalux/subscription_main.js", "subscription_main");
      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.overlay}>
          <View style={styles.copy}>
            <Text style={styles.title}>SUBSCRIPTION MAIN</Text>
          </View>
          <View style={styles.actions}>
            <TouchableOpacity style={styles.primaryBtn} onPress={() => go(['UserHome', 'ArtMain', 'GamesScreen', 'KamashastraScreen', 'HomeHub'])}>
              <Text style={styles.primaryText}>Continue</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.secondaryBtn} onPress={() => go(['signup_main', 'path_selection', 'HomeHub', 'MBWHome', 'RealmHome'])}>
