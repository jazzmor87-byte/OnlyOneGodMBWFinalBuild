...
export default function signup_main() {
  ...
  const __mbwPosterPool = getPosterPoolForScreen("app/screens/finalux/signup_main.js", "signup_main");
      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.overlay}>
          <View style={styles.copy}>
            <Text style={styles.title}>SIGNUP MAIN</Text>
          </View>
          <View style={styles.actions}>
            <TouchableOpacity style={styles.primaryBtn} onPress={() => go(['subscription_main', 'UserHome', 'GamesScreen', 'KamashastraScreen', 'HomeHub'])}>
              <Text style={styles.primaryText}>Continue</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.secondaryBtn} onPress={() => go(['path_selection', 'login_main', 'HomeHub', 'MBWHome', 'RealmHome'])}>
