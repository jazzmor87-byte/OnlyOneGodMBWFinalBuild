...
export default function art_main() {
  const navigation = useNavigation();
  const __mbwPosterPool = getPosterPoolForScreen("app/screens/finalux/art_main.js", "art_main");
      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.overlay}>
          <View style={styles.copy}>
            <Text style={styles.title}>ART MAIN</Text>
          </View>
          <View style={styles.actions}>
            <TouchableOpacity style={styles.primaryBtn} onPress={() => go(['border_crossing', 'login_main', 'GamesScreen', 'KamashastraScreen', 'HomeHub'])}>
              <Text style={styles.primaryText}>Continue</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.secondaryBtn} onPress={() => go(['SignupLux', 'PrivateChatLux', 'HomeHub', 'MBWHome', 'RealmHome'])}>
