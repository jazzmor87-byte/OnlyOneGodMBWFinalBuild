      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.overlay}>
          <View style={styles.copy}>
            <Text style={styles.title}>MBW COIN ORACLE SCREEN POSTER 02</Text>
          </View>
          <View style={styles.actions}>
            <TouchableOpacity style={styles.primaryBtn} onPress={() => go(['coin_main', 'wallet_main', 'CoinMarket', 'MasterOfCoinsMain', 'HomeHub'])}>
              <Text style={styles.primaryText}>Continue</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.secondaryBtn} onPress={() => go(['CoinsMainLux', 'MasterOfCoinsMain', 'HomeHub', 'MBWHome', 'RealmHome'])}>
