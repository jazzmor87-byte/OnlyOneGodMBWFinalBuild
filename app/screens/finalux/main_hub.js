      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.overlay}>
          <View style={styles.copy}>
            <Text style={styles.title}>MAIN HUB</Text>
          </View>
          <View style={styles.actions}>
            <TouchableOpacity style={styles.primaryBtn} onPress={() => go(["mb's_world_entry", 'realm_main_alt', 'MBWHome', 'RealmHome', 'HomeHub'])}>
              <Text style={styles.primaryText}>Continue</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.secondaryBtn} onPress={() => go(['RealmMainLux', 'RealmPrivilegesScreen', 'HomeHub', 'MBWHome', 'RealmHome'])}>
