      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.overlay}>
          ...
          <View style={styles.actions}>
            <TouchableOpacity style={styles.primaryBtn} onPress={() => go(['MatchmakingMain', 'MatchmakingScreen', 'MatchmakingHome', 'HomeHub'])}>
              <Text style={styles.primaryText}>Continue</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.secondaryBtn} onPress={() => go(['members_near_you', 'matchmaking_main', 'HomeHub', 'MBWHome', 'RealmHome'])}>
