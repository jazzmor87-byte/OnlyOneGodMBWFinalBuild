      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.overlay}>
          ...
          <View style={styles.actions}>
            <TouchableOpacity style={styles.primaryBtn} onPress={() => go(['match_extra', 'match_found', 'MatchmakingScreen', 'MatchmakingHome', 'HomeHub'])}>
              <Text style={styles.primaryText}>Continue</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.secondaryBtn} onPress={() => go(['MatchmakingMainLux', 'MatchFoundLux', 'HomeHub', 'MBWHome', 'RealmHome'])}>
