    ...
    <ImageBackground source={BG} style={s.bg} resizeMode="cover">
      ...
      <ScrollView contentContainerStyle={s.wrap} keyboardShouldPersistTaps="handled">
        <View style={s.card}>
          ...
          <Text style={s.p}>Enter as {role} through {accessLabel}.</Text>
          <View style={s.form}>
          ...
          <TouchableOpacity style={s.btn} onPress={goNext} activeOpacity={0.9}><Text style={s.t}>CONTINUE</Text></TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate("SignupLux", { role, accessPath })} activeOpacity={0.9}>
            <Text style={s.switchText}>NEW HERE? SIGN UP</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </ImageBackground>
