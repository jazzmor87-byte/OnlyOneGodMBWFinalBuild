      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.overlay}>
          ...
          <View style={styles.actions}>
            <TouchableOpacity style={styles.primaryBtn} onPress={() => go(['travel_overseas', 'TravelMain', 'TravelScreen', 'TravelInbox', 'HomeHub'])}>
              <Text style={styles.primaryText}>Continue</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.secondaryBtn} onPress={() => go(['host_circle', 'TravelOverseasLux', 'HomeHub', 'MBWHome', 'RealmHome'])}>
