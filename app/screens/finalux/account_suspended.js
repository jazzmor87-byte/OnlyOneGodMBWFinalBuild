      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.overlay}>
          ...
          <View style={styles.actions}>
            <TouchableOpacity style={styles.primaryBtn} onPress={() => go(['GateScreen', 'PathSelectionScreen', 'Login', 'Signup', 'Subscription', 'HomeHub'])}>
              <Text style={styles.primaryText}>Continue</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.secondaryBtn} onPress={() => go(['PathSelectionLux', 'Signup', 'HomeHub', 'MBWHome', 'RealmHome'])}>
