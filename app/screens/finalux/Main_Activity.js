...
export default function Main_Activity() {
  ...
  const __mbwPosterPool = getPosterPoolForScreen("app/screens/finalux/Main_Activity.js", "Main_Activity");
      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.overlay}>
          <View style={styles.copy}>
            <Text style={styles.title}>MAIN ACTIVITY</Text>
          </View>
          <View style={styles.actions}>
            <TouchableOpacity style={styles.primaryBtn} onPress={() => go(['PrivateChatLux', 'SignupLux', 'GamesScreen', 'KamashastraScreen', 'HomeHub'])}>
              <Text style={styles.primaryText}>Continue</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.secondaryBtn} onPress={() => go(['LoginLux', 'GamesMainLux', 'HomeHub', 'MBWHome', 'RealmHome'])}>
