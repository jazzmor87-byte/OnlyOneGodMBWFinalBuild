      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.overlay}>
          <View style={styles.copy}>
            <Text style={styles.title}>SAFE MEET ATLAS</Text>
          </View>
          <View style={styles.actions}>
            <TouchableOpacity style={styles.primaryBtn} onPress={() => go(['TravelOverseasLux', 'host_circle', 'TravelScreen', 'TravelInbox', 'HomeHub'])}>
              <Text style={styles.primaryText}>Continue</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.secondaryBtn} onPress={() => go(['TravelLedgerScreen', 'SafeMeetAtlasScreen', 'HomeHub', 'MBWHome', 'RealmHome'])}>
