...
export default function profile_main() {
  ...
  const __mbwPosterPool = getPosterPoolForScreen("app/screens/finalux/profile_main.js", "profile_main");
  const __mbwPickedPoster = pickPosterForIndex(__mbwPosterPool, 0) || require("../../assets/mbw_luxscreens/profile_main.png");
      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.overlay}>
          <View style={styles.copy}>
            <Text style={styles.title}>PROFILE MAIN</Text>
          </View>
          <View style={styles.actions}>
            <TouchableOpacity style={styles.primaryBtn} onPress={() => go(['ProfileMain', 'Profile', 'ProfileHome', 'HomeHub'])}>
              <Text style={styles.primaryText}>Continue</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.secondaryBtn} onPress={() => go(['ProfileMainLux', 'ProfileCrownScreen', 'HomeHub', 'MBWHome', 'RealmHome'])}>
