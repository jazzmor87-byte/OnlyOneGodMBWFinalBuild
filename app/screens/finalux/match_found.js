...
export default function match_found() {
  ...
  const __mbwPosterPool = getPosterPoolForScreen("app/screens/finalux/match_found.js", "match_found");
  const __mbwPickedPoster = pickPosterForIndex(__mbwPosterPool, 0) || require("../../assets/mbw_luxscreens/matchmaking_main.png");
      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.overlay}>
          ...
          <View style={styles.actions}>
            <TouchableOpacity style={styles.primaryBtn} onPress={() => go(['matchmaking_main', 'members_near_you', 'MatchmakingScreen', 'MatchmakingHome', 'HomeHub'])}>
              <Text style={styles.primaryText}>Continue</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.secondaryBtn} onPress={() => go(['match_extra', 'match_details', 'HomeHub', 'MBWHome', 'RealmHome'])}>
