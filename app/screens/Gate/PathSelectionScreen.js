...
function CompactCard({ title, desc, onLogin, onSignup }) {
  return (
...
const s = StyleSheet.create({
  ...
  routeTitle: { color: "#FAE8B8", fontSize: 16, fontWeight: "900", textAlign: "center" },
  ...
  smallBtnText: { color: "#FAE8B8", fontSize: 14, fontWeight: "900" }
});
