...
export const ACTIVE_HARDCORE_COMPONENT_EXPORT = "KamashastraPoster:ACTIVE_HARDCORE_COMPONENT_EXPORT";
export const ROUTE_HARDCORE_RUNTIME_BINDING = "KamashastraPoster:ROUTE_HARDCORE_RUNTIME_BINDING";
export const ACTIVE_STATE_ENGINE = "KamashastraPoster:ACTIVE_STATE_ENGINE";
export const VISUAL_IMPACT_ENGINE = "KamashastraPoster:VISUAL_IMPACT_ENGINE";
export const ENTRY_ACTION_STATE_RESULT_RETURN = "KamashastraPoster:ENTRY_ACTION_STATE_RESULT_RETURN";
export const SECTION_ACTION_LOGIC = "KamashastraPoster:SECTION_ACTION_LOGIC";
export const SECTION_STATE_LOGIC = "KamashastraPoster:SECTION_STATE_LOGIC";
export const SECTION_SCREEN_BODY = "KamashastraPoster:SECTION_SCREEN_BODY";
export const POSTER_OWNER_ALIGNMENT = "KamashastraPoster:POSTER_OWNER_ALIGNMENT";
...
export const MBW_ONE_BODY_SCREEN_CONTRACT = {
  ...
  ACTIVE_HARDCORE_COMPONENT_EXPORT: "KamashastraPoster:ACTIVE_HARDCORE_COMPONENT_EXPORT",
  ROUTE_HARDCORE_RUNTIME_BINDING: "KamashastraPoster:ROUTE_HARDCORE_RUNTIME_BINDING",
  ACTIVE_STATE_ENGINE: "KamashastraPoster:ACTIVE_STATE_ENGINE",
  VISUAL_IMPACT_ENGINE: "KamashastraPoster:VISUAL_IMPACT_ENGINE",
  ENTRY_ACTION_STATE_RESULT_RETURN: "KamashastraPoster:ENTRY_ACTION_STATE_RESULT_RETURN",
  SECTION_ACTION_LOGIC: "KamashastraPoster:SECTION_ACTION_LOGIC",
