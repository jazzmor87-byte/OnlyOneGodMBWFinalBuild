...
export const POSTER_ASSET_OWNER = "MBW_8D70HW_POSTER_ASSET_OWNER::MerchandiseLive::Merchandise";
// MBW_8D70HW_QBUILDER_POSTER_ASSET_REQUIRE = require("../../../assets/mbw_clean_shuffled_visual_body_posters/MainHubScreen.jpg");
export const MBW_ROUTE_NAME = "MerchandiseLive";
export const ACTIVE_HARDCORE_COMPONENT_EXPORT = "MerchandiseLive:ACTIVE_HARDCORE_COMPONENT_EXPORT";
export const ROUTE_HARDCORE_RUNTIME_BINDING = "MerchandiseLive:ROUTE_HARDCORE_RUNTIME_BINDING";
export const ACTIVE_STATE_ENGINE = "MerchandiseLive:ACTIVE_STATE_ENGINE";
export const VISUAL_IMPACT_ENGINE = "MerchandiseLive:VISUAL_IMPACT_ENGINE";
export const ENTRY_ACTION_STATE_RESULT_RETURN = "MerchandiseLive:ENTRY_ACTION_STATE_RESULT_RETURN";
export const SECTION_ACTION_LOGIC = "MerchandiseLive:SECTION_ACTION_LOGIC";
export const SECTION_STATE_LOGIC = "MerchandiseLive:SECTION_STATE_LOGIC";
export const SECTION_SCREEN_BODY = "MerchandiseLive:SECTION_SCREEN_BODY";
export const POSTER_OWNER_ALIGNMENT = "MerchandiseLive:POSTER_OWNER_ALIGNMENT";
...
export const MBW_ONE_BODY_SCREEN_CONTRACT = {
  ...
  ACTIVE_HARDCORE_COMPONENT_EXPORT: "MerchandiseLive:ACTIVE_HARDCORE_COMPONENT_EXPORT",
  ROUTE_HARDCORE_RUNTIME_BINDING: "MerchandiseLive:ROUTE_HARDCORE_RUNTIME_BINDING",
  ACTIVE_STATE_ENGINE: "MerchandiseLive:ACTIVE_STATE_ENGINE",
  VISUAL_IMPACT_ENGINE: "MerchandiseLive:VISUAL_IMPACT_ENGINE",
  ENTRY_ACTION_STATE_RESULT_RETURN: "MerchandiseLive:ENTRY_ACTION_STATE_RESULT_RETURN",
  SECTION_ACTION_LOGIC: "MerchandiseLive:SECTION_ACTION_LOGIC",
  SECTION_STATE_LOGIC: "MerchandiseLive:SECTION_STATE_LOGIC",
  SECTION_SCREEN_BODY: "MerchandiseLive:SECTION_SCREEN_BODY",
  POSTER_OWNER_ALIGNMENT: "MerchandiseLive:POSTER_OWNER_ALIGNMENT",
  POSTER_ASSET_UNIQUE_FOR_ROUTE: "MerchandiseLive:POSTER_ASSET_UNIQUE_FOR_ROUTE"
};
export function MerchandiseLiveScreen(props) {
...
export default withMBWExactVisualOS(MerchandiseLiveScreen, {
  screenId: "MerchandiseLiveScreen"
});
