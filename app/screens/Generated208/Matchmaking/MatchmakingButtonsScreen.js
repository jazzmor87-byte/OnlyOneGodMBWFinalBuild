...
export const POSTER_ASSET_OWNER = "MBW_8D70HW_POSTER_ASSET_OWNER::MatchmakingButtons::Matchmaking";
// MBW_8D70HW_QBUILDER_POSTER_ASSET_REQUIRE = require("../../../assets/mbw_clean_shuffled_visual_body_posters/MainHubScreen.jpg");
export const MBW_ROUTE_NAME = "MatchmakingButtons";
export const ACTIVE_HARDCORE_COMPONENT_EXPORT = "MatchmakingButtons:ACTIVE_HARDCORE_COMPONENT_EXPORT";
export const ROUTE_HARDCORE_RUNTIME_BINDING = "MatchmakingButtons:ROUTE_HARDCORE_RUNTIME_BINDING";
export const ACTIVE_STATE_ENGINE = "MatchmakingButtons:ACTIVE_STATE_ENGINE";
export const VISUAL_IMPACT_ENGINE = "MatchmakingButtons:VISUAL_IMPACT_ENGINE";
export const ENTRY_ACTION_STATE_RESULT_RETURN = "MatchmakingButtons:ENTRY_ACTION_STATE_RESULT_RETURN";
export const SECTION_ACTION_LOGIC = "MatchmakingButtons:SECTION_ACTION_LOGIC";
export const SECTION_STATE_LOGIC = "MatchmakingButtons:SECTION_STATE_LOGIC";
export const SECTION_SCREEN_BODY = "MatchmakingButtons:SECTION_SCREEN_BODY";
export const POSTER_OWNER_ALIGNMENT = "MatchmakingButtons:POSTER_OWNER_ALIGNMENT";
...
export const MBW_ONE_BODY_SCREEN_CONTRACT = {
  ...
  ACTIVE_HARDCORE_COMPONENT_EXPORT: "MatchmakingButtons:ACTIVE_HARDCORE_COMPONENT_EXPORT",
  ROUTE_HARDCORE_RUNTIME_BINDING: "MatchmakingButtons:ROUTE_HARDCORE_RUNTIME_BINDING",
  ACTIVE_STATE_ENGINE: "MatchmakingButtons:ACTIVE_STATE_ENGINE",
  VISUAL_IMPACT_ENGINE: "MatchmakingButtons:VISUAL_IMPACT_ENGINE",
  ENTRY_ACTION_STATE_RESULT_RETURN: "MatchmakingButtons:ENTRY_ACTION_STATE_RESULT_RETURN",
  SECTION_ACTION_LOGIC: "MatchmakingButtons:SECTION_ACTION_LOGIC",
  SECTION_STATE_LOGIC: "MatchmakingButtons:SECTION_STATE_LOGIC",
  SECTION_SCREEN_BODY: "MatchmakingButtons:SECTION_SCREEN_BODY",
  POSTER_OWNER_ALIGNMENT: "MatchmakingButtons:POSTER_OWNER_ALIGNMENT",
  POSTER_ASSET_UNIQUE_FOR_ROUTE: "MatchmakingButtons:POSTER_ASSET_UNIQUE_FOR_ROUTE"
};
export function MatchmakingButtonsScreen(props) {
...
export default withMBWExactVisualOS(MatchmakingButtonsScreen, {
  screenId: "MatchmakingButtonsScreen"
});
