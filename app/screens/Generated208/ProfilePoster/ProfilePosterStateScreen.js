...
export const POSTER_ASSET_OWNER = "MBW_8D70HW_POSTER_ASSET_OWNER::ProfilePosterState::ProfilePoster";
// MBW_8D70HW_QBUILDER_POSTER_ASSET_REQUIRE = require("../../../assets/mbw_clean_shuffled_visual_body_posters/MainHubScreen.jpg");
export const MBW_ROUTE_NAME = "ProfilePosterState";
export const ACTIVE_HARDCORE_COMPONENT_EXPORT = "ProfilePosterState:ACTIVE_HARDCORE_COMPONENT_EXPORT";
export const ROUTE_HARDCORE_RUNTIME_BINDING = "ProfilePosterState:ROUTE_HARDCORE_RUNTIME_BINDING";
export const ACTIVE_STATE_ENGINE = "ProfilePosterState:ACTIVE_STATE_ENGINE";
export const VISUAL_IMPACT_ENGINE = "ProfilePosterState:VISUAL_IMPACT_ENGINE";
export const ENTRY_ACTION_STATE_RESULT_RETURN = "ProfilePosterState:ENTRY_ACTION_STATE_RESULT_RETURN";
export const SECTION_ACTION_LOGIC = "ProfilePosterState:SECTION_ACTION_LOGIC";
export const SECTION_STATE_LOGIC = "ProfilePosterState:SECTION_STATE_LOGIC";
export const SECTION_SCREEN_BODY = "ProfilePosterState:SECTION_SCREEN_BODY";
export const POSTER_OWNER_ALIGNMENT = "ProfilePosterState:POSTER_OWNER_ALIGNMENT";
...
export const MBW_ONE_BODY_SCREEN_CONTRACT = {
  ...
  ACTIVE_HARDCORE_COMPONENT_EXPORT: "ProfilePosterState:ACTIVE_HARDCORE_COMPONENT_EXPORT",
  ROUTE_HARDCORE_RUNTIME_BINDING: "ProfilePosterState:ROUTE_HARDCORE_RUNTIME_BINDING",
  ACTIVE_STATE_ENGINE: "ProfilePosterState:ACTIVE_STATE_ENGINE",
  VISUAL_IMPACT_ENGINE: "ProfilePosterState:VISUAL_IMPACT_ENGINE",
  ENTRY_ACTION_STATE_RESULT_RETURN: "ProfilePosterState:ENTRY_ACTION_STATE_RESULT_RETURN",
  SECTION_ACTION_LOGIC: "ProfilePosterState:SECTION_ACTION_LOGIC",
  SECTION_STATE_LOGIC: "ProfilePosterState:SECTION_STATE_LOGIC",
  SECTION_SCREEN_BODY: "ProfilePosterState:SECTION_SCREEN_BODY",
  POSTER_OWNER_ALIGNMENT: "ProfilePosterState:POSTER_OWNER_ALIGNMENT",
  POSTER_ASSET_UNIQUE_FOR_ROUTE: "ProfilePosterState:POSTER_ASSET_UNIQUE_FOR_ROUTE"
};
export function ProfilePosterStateScreen(props) {
...
export default withMBWExactVisualOS(ProfilePosterStateScreen, {
  screenId: "ProfilePosterStateScreen"
});
