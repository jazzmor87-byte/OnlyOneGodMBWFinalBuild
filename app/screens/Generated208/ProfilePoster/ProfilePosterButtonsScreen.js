...
export const POSTER_ASSET_OWNER = "MBW_8D70HW_POSTER_ASSET_OWNER::ProfilePosterButtons::ProfilePoster";
// MBW_8D70HW_QBUILDER_POSTER_ASSET_REQUIRE = require("../../../assets/mbw_clean_shuffled_visual_body_posters/MainHubScreen.jpg");
export const MBW_ROUTE_NAME = "ProfilePosterButtons";
export const ACTIVE_HARDCORE_COMPONENT_EXPORT = "ProfilePosterButtons:ACTIVE_HARDCORE_COMPONENT_EXPORT";
export const ROUTE_HARDCORE_RUNTIME_BINDING = "ProfilePosterButtons:ROUTE_HARDCORE_RUNTIME_BINDING";
export const ACTIVE_STATE_ENGINE = "ProfilePosterButtons:ACTIVE_STATE_ENGINE";
export const VISUAL_IMPACT_ENGINE = "ProfilePosterButtons:VISUAL_IMPACT_ENGINE";
export const ENTRY_ACTION_STATE_RESULT_RETURN = "ProfilePosterButtons:ENTRY_ACTION_STATE_RESULT_RETURN";
export const SECTION_ACTION_LOGIC = "ProfilePosterButtons:SECTION_ACTION_LOGIC";
export const SECTION_STATE_LOGIC = "ProfilePosterButtons:SECTION_STATE_LOGIC";
export const SECTION_SCREEN_BODY = "ProfilePosterButtons:SECTION_SCREEN_BODY";
export const POSTER_OWNER_ALIGNMENT = "ProfilePosterButtons:POSTER_OWNER_ALIGNMENT";
...
export const MBW_ONE_BODY_SCREEN_CONTRACT = {
  routeName: "ProfilePosterButtons",
  ...
  ACTIVE_HARDCORE_COMPONENT_EXPORT: "ProfilePosterButtons:ACTIVE_HARDCORE_COMPONENT_EXPORT",
  ROUTE_HARDCORE_RUNTIME_BINDING: "ProfilePosterButtons:ROUTE_HARDCORE_RUNTIME_BINDING",
  ACTIVE_STATE_ENGINE: "ProfilePosterButtons:ACTIVE_STATE_ENGINE",
  VISUAL_IMPACT_ENGINE: "ProfilePosterButtons:VISUAL_IMPACT_ENGINE",
  ENTRY_ACTION_STATE_RESULT_RETURN: "ProfilePosterButtons:ENTRY_ACTION_STATE_RESULT_RETURN",
  SECTION_ACTION_LOGIC: "ProfilePosterButtons:SECTION_ACTION_LOGIC",
  SECTION_STATE_LOGIC: "ProfilePosterButtons:SECTION_STATE_LOGIC",
  SECTION_SCREEN_BODY: "ProfilePosterButtons:SECTION_SCREEN_BODY",
  POSTER_OWNER_ALIGNMENT: "ProfilePosterButtons:POSTER_OWNER_ALIGNMENT",
  POSTER_ASSET_UNIQUE_FOR_ROUTE: "ProfilePosterButtons:POSTER_ASSET_UNIQUE_FOR_ROUTE"
};
export function ProfilePosterButtonsScreen(props) {
...
export default withMBWExactVisualOS(ProfilePosterButtonsScreen, {
  screenId: "ProfilePosterButtonsScreen"
});
