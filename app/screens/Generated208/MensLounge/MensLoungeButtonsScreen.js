...
export const POSTER_ASSET_OWNER = "MBW_8D70HW_POSTER_ASSET_OWNER::MensLoungeButtons::MensLounge";
// MBW_8D70HW_QBUILDER_POSTER_ASSET_REQUIRE = require("../../../assets/mbw_clean_shuffled_visual_body_posters/MainHubScreen.jpg");
export const MBW_ROUTE_NAME = "MensLoungeButtons";
export const ACTIVE_HARDCORE_COMPONENT_EXPORT = "MensLoungeButtons:ACTIVE_HARDCORE_COMPONENT_EXPORT";
export const ROUTE_HARDCORE_RUNTIME_BINDING = "MensLoungeButtons:ROUTE_HARDCORE_RUNTIME_BINDING";
export const ACTIVE_STATE_ENGINE = "MensLoungeButtons:ACTIVE_STATE_ENGINE";
export const VISUAL_IMPACT_ENGINE = "MensLoungeButtons:VISUAL_IMPACT_ENGINE";
export const ENTRY_ACTION_STATE_RESULT_RETURN = "MensLoungeButtons:ENTRY_ACTION_STATE_RESULT_RETURN";
export const SECTION_ACTION_LOGIC = "MensLoungeButtons:SECTION_ACTION_LOGIC";
export const SECTION_STATE_LOGIC = "MensLoungeButtons:SECTION_STATE_LOGIC";
export const SECTION_SCREEN_BODY = "MensLoungeButtons:SECTION_SCREEN_BODY";
export const POSTER_OWNER_ALIGNMENT = "MensLoungeButtons:POSTER_OWNER_ALIGNMENT";
...
export const MBW_ONE_BODY_SCREEN_CONTRACT = {
  ...
  ACTIVE_HARDCORE_COMPONENT_EXPORT: "MensLoungeButtons:ACTIVE_HARDCORE_COMPONENT_EXPORT",
  ROUTE_HARDCORE_RUNTIME_BINDING: "MensLoungeButtons:ROUTE_HARDCORE_RUNTIME_BINDING",
  ACTIVE_STATE_ENGINE: "MensLoungeButtons:ACTIVE_STATE_ENGINE",
  VISUAL_IMPACT_ENGINE: "MensLoungeButtons:VISUAL_IMPACT_ENGINE",
  ENTRY_ACTION_STATE_RESULT_RETURN: "MensLoungeButtons:ENTRY_ACTION_STATE_RESULT_RETURN",
  SECTION_ACTION_LOGIC: "MensLoungeButtons:SECTION_ACTION_LOGIC",
  SECTION_STATE_LOGIC: "MensLoungeButtons:SECTION_STATE_LOGIC",
  SECTION_SCREEN_BODY: "MensLoungeButtons:SECTION_SCREEN_BODY",
  POSTER_OWNER_ALIGNMENT: "MensLoungeButtons:POSTER_OWNER_ALIGNMENT",
  POSTER_ASSET_UNIQUE_FOR_ROUTE: "MensLoungeButtons:POSTER_ASSET_UNIQUE_FOR_ROUTE"
};
export function MensLoungeButtonsScreen(props) {
...
export default withMBWExactVisualOS(MensLoungeButtonsScreen, {
  screenId: "MensLoungeButtonsScreen"
});
