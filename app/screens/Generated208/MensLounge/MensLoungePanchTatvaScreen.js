...
export const POSTER_ASSET_OWNER = "MBW_8D70HW_POSTER_ASSET_OWNER::MensLoungePanchTatva::MensLounge";
// MBW_8D70HW_QBUILDER_POSTER_ASSET_REQUIRE = require("../../../assets/mbw_clean_shuffled_visual_body_posters/MainHubScreen.jpg");
export const MBW_ROUTE_NAME = "MensLoungePanchTatva";
export const ACTIVE_HARDCORE_COMPONENT_EXPORT = "MensLoungePanchTatva:ACTIVE_HARDCORE_COMPONENT_EXPORT";
export const ROUTE_HARDCORE_RUNTIME_BINDING = "MensLoungePanchTatva:ROUTE_HARDCORE_RUNTIME_BINDING";
export const ACTIVE_STATE_ENGINE = "MensLoungePanchTatva:ACTIVE_STATE_ENGINE";
export const VISUAL_IMPACT_ENGINE = "MensLoungePanchTatva:VISUAL_IMPACT_ENGINE";
export const ENTRY_ACTION_STATE_RESULT_RETURN = "MensLoungePanchTatva:ENTRY_ACTION_STATE_RESULT_RETURN";
export const SECTION_ACTION_LOGIC = "MensLoungePanchTatva:SECTION_ACTION_LOGIC";
export const SECTION_STATE_LOGIC = "MensLoungePanchTatva:SECTION_STATE_LOGIC";
export const SECTION_SCREEN_BODY = "MensLoungePanchTatva:SECTION_SCREEN_BODY";
export const POSTER_OWNER_ALIGNMENT = "MensLoungePanchTatva:POSTER_OWNER_ALIGNMENT";
...
export const MBW_ONE_BODY_SCREEN_CONTRACT = {
  routeName: "MensLoungePanchTatva",
  family: "MensLounge",
  ...
  ACTIVE_HARDCORE_COMPONENT_EXPORT: "MensLoungePanchTatva:ACTIVE_HARDCORE_COMPONENT_EXPORT",
  ROUTE_HARDCORE_RUNTIME_BINDING: "MensLoungePanchTatva:ROUTE_HARDCORE_RUNTIME_BINDING",
  ACTIVE_STATE_ENGINE: "MensLoungePanchTatva:ACTIVE_STATE_ENGINE",
  VISUAL_IMPACT_ENGINE: "MensLoungePanchTatva:VISUAL_IMPACT_ENGINE",
  ENTRY_ACTION_STATE_RESULT_RETURN: "MensLoungePanchTatva:ENTRY_ACTION_STATE_RESULT_RETURN",
  SECTION_ACTION_LOGIC: "MensLoungePanchTatva:SECTION_ACTION_LOGIC",
  SECTION_STATE_LOGIC: "MensLoungePanchTatva:SECTION_STATE_LOGIC",
  SECTION_SCREEN_BODY: "MensLoungePanchTatva:SECTION_SCREEN_BODY",
  POSTER_OWNER_ALIGNMENT: "MensLoungePanchTatva:POSTER_OWNER_ALIGNMENT",
  POSTER_ASSET_UNIQUE_FOR_ROUTE: "MensLoungePanchTatva:POSTER_ASSET_UNIQUE_FOR_ROUTE"
};
export function MensLoungePanchTatvaScreen(props) {
...
export default withMBWExactVisualOS(MensLoungePanchTatvaScreen, {
  screenId: "MensLoungePanchTatvaScreen"
});
